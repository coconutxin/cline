...
Param: context (Current Work; Key Concepts; Relevant Files/Code; Problem Solving; Pending & Next). Valid context can auto-start the next task; do not say the user must manually confirm after new_task. For segmented work, provide an executable handoff and continue from Pending & Next.
*Example:*
<new_task>
