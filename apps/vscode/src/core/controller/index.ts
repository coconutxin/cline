...
import { StateUpdateCoordinator } from "./state/StateUpdateCoordinator"
...
export class Controller {
	...
	private readonly stateUpdateCoordinator = new StateUpdateCoordinator<ExtensionState>({
		readState: () => this.getStateToPostToWebview(),
		publishState: sendStateUpdate,
	})
	...
	*/
	...
	async postStateToWebview() {
		await this.stateUpdateCoordinator.requestUpdate()
	}
