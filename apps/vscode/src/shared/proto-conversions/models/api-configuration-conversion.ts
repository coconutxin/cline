...
export function convertApiConfigurationToProto(config: ApiConfiguration): ProtoApiConfiguration {
	return {
		...
		planModeOpenAiCodexServiceTier: config.planModeOpenAiCodexServiceTier,
		...
		actModeOpenAiCodexServiceTier: config.actModeOpenAiCodexServiceTier,
...
export function convertProtoToApiConfiguration(protoConfig: ProtoApiConfiguration): ApiConfiguration {
	return {
		...
		planModeOpenAiCodexServiceTier: protoConfig.planModeOpenAiCodexServiceTier,
		...
		actModeOpenAiCodexServiceTier: protoConfig.actModeOpenAiCodexServiceTier,
